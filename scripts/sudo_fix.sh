...
# MixwareScreen sudo fix. Modified from moonraker-sudo
...
SUDOERS_FILE='022-sudo-for-mixwarescreen'
NEW_GROUP='mixwarescreensudo'
...
Cmnd_Alias SYSTEMCTL_MS_RESTART = /bin/systemctl restart MixwareScreen

%GROUPNAME ALL=(ALL) NOPASSWD: IWCONFGI, IWLIST, SYSTEMCTL_MS_RESTART
#EOF
